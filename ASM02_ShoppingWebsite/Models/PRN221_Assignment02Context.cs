...
namespace ASM02_ShoppingWebsite.Models
{
    ...
    {
        public static PRN221_Assignment02Context ins = new PRN221_Assignment02Context();
        public PRN221_Assignment02Context()
        {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Account>(entity =>
            {
                ...
                entity.HasIndex(e => e.UserName, "UQ__Account__C9F28456719D209D")
                    .IsUnique();
            ...
            modelBuilder.Entity<OrderDetail>(entity =>
            {
                entity.HasKey(e => new { e.OrderId, e.ProductId })
                    .HasName("PK__OrderDet__08D097C1142C6C6E");
            ...
            modelBuilder.Entity<Product>(entity =>
            {
                ...
                entity.Property(e => e.IsPizzaOfTheWeek).HasDefaultValueSql("((0))");
